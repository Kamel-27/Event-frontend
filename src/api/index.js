...
export const getUserEvents = (params) => API.get("/events/user/events", { params });
...
export const checkInTicket = (qrCode) => API.post("/tickets/check-in", { qrCode });
export const cancelTicket = (ticketId) => API.put(`/tickets/cancel/${ticketId}`);
...
export const getAttendeeInsights = (eventId = null) => API.get("/analytics/attendee-insights", { params: eventId ? { eventId } : {} });
